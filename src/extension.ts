...
interface IAdvplSymbol {
    /**
     * Nome do S�mbolo - Ser� exibido na outline
     */
    name: string;

    /**
     * Detalhe do s�mbolo - Informa��o complementar que ser� exibida na outline
     */
    detail: string;

    /**
     * Identifica��o do n�vel do s�mbolo
     */
    level: Number;

    /**
	 * O tipo desse s�mbolo.
	 */
    kind: vscode.SymbolKind;

    /**
	 * O intervalo que inclui esse s�mbolo n�o inclui espa�o em branco inicial / final, mas todo o restante, por exemplo, coment�rios e c�digo.
	 */
    range: vscode.Range;

    /**
     * O intervalo que deve ser selecionado e revela quando este s�mbolo est� sendo escolhido, por exemplo, o nome de uma fun��o.
     */
